...
`hns-browser-transport`, `hns-browser-gateway`, `hns-browser-loopback-proxy`,
and `hns-browser-urkel` are temporary product-adapter consolidation packages.
All twelve must retain
